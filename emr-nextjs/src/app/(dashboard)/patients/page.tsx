...
export default function PatientsPage() {
  ...
  const stats = {
    ...
    male: allPatients.filter((p) => p.gender === 'Nam').length,
    female: allPatients.filter((p) => p.gender === 'Nữ').length,
    active: allPatients.filter((p) => p.medicalHistory === 'Không').length,
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
          ...
          <p className="text-gray-500 text-xs mt-2">👨 {Math.round((stats.male / stats.total) * 100)}%</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-pink-500">
          ...
          <p className="text-gray-500 text-xs mt-2">👩 {Math.round((stats.female / stats.total) * 100)}%</p>
        </div>
